...
async def gen_thumb(videoid):
    ...
    arial = ImageFont.truetype("AMMusicV2/assets/font2.ttf", 30)
    font = ImageFont.truetype("AMMusicV2/assets/font.ttf", 30)
    title_font = ImageFont.truetype("AMMusicV2/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("AMMusicV2/assets/play_icons.png")
    play_icons = play_icons.resize((580, 62))

    #gradient = Image.new('L', (play_icons.width, play_icons.height), color=0xFF)
    #top = Image.new('L', (play_icons.width, 30), color=0xFF)
    #bottom = Image.new('L', (play_icons.width, 30), color=0x00)
    #gradient.paste(top, (0, 0))
    #gradient.paste(bottom, (0, play_icons.height - 30))
